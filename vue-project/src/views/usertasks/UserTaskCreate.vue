...
const { usertasks, storeUserTask, errors } = useUserTasks()
...
<template>
  <div class="m-5">
    <form class="border border-dark p-4 col-md-9 m-2" @submit.prevent="storeUserTask(form)">
      ...
      <div class="mb-3">
        ...
        <select v-model="form.task_id" class="form-select" aria-label="Default select example">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" v-model="form.remarks" id="remarks" rows="3"></textarea>
        <!---If error occurs-->
